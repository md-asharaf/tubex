...
export const SearchedVideos = () => {
    ...
    const { data: shorts, isLoading: shortsLoading } = useQuery({
        ...
        queryFn: async (): Promise<IShortData[]> => {
            ...
            return data.data.data.shorts; // axios wraps in data, and ApiResponse has data.shorts
        },
    ...
    return (
        <div className="flex flex-col w-full min-h-screen">
            <div className="sticky top-14 z-10 bg-background/95 backdrop-blur w-full border-b">
