...
export const ForgotPassword = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0f0f0f] flex items-center justify-center p-4">
      ...
      <div className="bg-white dark:bg-[#212121] rounded-2xl p-8 max-w-[450px] w-full border border-gray-200 dark:border-white/10 md:shadow-sm">
        <div className="flex flex-col items-center mb-8">
          <div className="flex items-center gap-1 mb-4">
            <img src="./src/assets/images/logo.png" alt="TubeX Logo" className="w-8 h-8" />
            ...
            <div className="space-y-2">
              {users.map((user) => (
                <button
                  ...
                  className={`w-full flex items-center p-3 rounded-xl transition-colors border ${selectedUserId === user._id
                ...
                >
                  ...
                  <div className="flex flex-col items-start">
                    <span className="font-medium text-black dark:text-white">{user.fullname}</span>
